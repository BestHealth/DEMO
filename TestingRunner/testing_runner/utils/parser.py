...
class Format(object):
    ...
    def __init__(self, body, level='test'):
        ...
        try:
            ...
            response_headers = body.get('resp_header')
            ...
            self.__response_desc = {
                'resp_header': '',
            }
            if response_headers:
                resp_header_desc = response_headers.get('desc')
                self.__response_desc.update({'resp_header': resp_header_desc})
    ...
    def parse(self):
        ...
        if self.__response_desc:
            response['desc'] = self.__response_desc
...
class ResponseFront(object):
    def __init__(self, body):
        response = body.get('response')
        self.__response_headers = None
        self.__response_json = None
        self.__response_desc = None
        self.__response_desc = {
            'resp_header': '',
        }
        ...
        if resp_desc:
            resp_header_desc = resp_desc.get('resp_header')
            self.__response_desc.update({'resp_header': resp_header_desc})
    ...
    def response_http(self):
        ...
        if self.__response_headers:
            ...
            for key, value in self.__response_headers.items():
                response['resp_header'].append({
                    'key': key,
                    'value': value,
                    'desc': self.__response_desc['resp_header'][key]
                })
        if self.__response_json:
